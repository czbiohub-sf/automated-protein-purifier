...
class Ui_BuffersWindow(object):
    ...
    def retranslateUi(self, BuffersWindow):
        ...
        self.base_fc_txtbox.setInputMask(_translate("BuffersWindow", "999"))
        self.elution_fc_txtbox.setInputMask(_translate("BuffersWindow", "999"))
        self.load_fc_txtbox.setInputMask(_translate("BuffersWindow", "999"))
        self.wash_fc_txtbox.setInputMask(_translate("BuffersWindow", "999"))
