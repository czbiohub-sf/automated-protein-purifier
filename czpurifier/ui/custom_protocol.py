...
class Ui_CustomProtocol(object):
    ...
    def setupUi(self, CustomProtocol):
        ...
        self.add_step_widget = QtWidgets.QWidget(self.scrollAreaWidgetContents)
        self.add_step_widget.setObjectName("add_step_widget")
        ...
        self.volume_val_lbl = QtWidgets.QLabel(self.add_step_widget)
        ...
        self.verticalLayout_5.addWidget(self.add_step_widget)
        self.add_step_btn = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.add_step_btn.setFont(font)
        self.add_step_btn.setObjectName("add_step_btn")
        self.verticalLayout_5.addWidget(self.add_step_btn)
