...
# Form implementation generated from reading ui file 'desgin_files/purification.ui'
#
...
class Ui_PurificationWindow(object):
    def setupUi(self, PurificationWindow):
        PurificationWindow.setObjectName("PurificationWindow")
        PurificationWindow.setWindowModality(QtCore.Qt.ApplicationModal)
        PurificationWindow.resize(1440, 900)
        self.centralwidget = QtWidgets.QWidget(PurificationWindow)
...
"QPushButton:disabled#stop_btn{background-color:#696969}")
        ...
        PurificationWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(PurificationWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1440, 22))
        self.menubar.setObjectName("menubar")
        PurificationWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(PurificationWindow)
        self.statusbar.setObjectName("statusbar")
        PurificationWindow.setStatusBar(self.statusbar)

        self.retranslateUi(PurificationWindow)
        QtCore.QMetaObject.connectSlotsByName(PurificationWindow)

    def retranslateUi(self, PurificationWindow):
        _translate = QtCore.QCoreApplication.translate
        PurificationWindow.setWindowTitle(_translate("PurificationWindow", "Purification"))
        self.label_10.setText(_translate("PurificationWindow", "<html><head/><body><p>Run basic purification protocols using the following window. </p><p>To change the column size please close the window and update the column size in the main window.</p><p>The per column calibration from the main window will be applied to protocols here, to update the calibration please close the window and update the calibration on the main window.</p><p>On START a prompt will display the buffer and load volumes needed, along with the ability to update buffer dependent flow rates.</p></body></html>"))
        self.num_col_lbl.setText(_translate("PurificationWindow", "Number of Columns: "))
        self.num_col_combo_box.setItemText(0, _translate("PurificationWindow", "1"))
        self.num_col_combo_box.setItemText(1, _translate("PurificationWindow", "2"))
        self.num_col_combo_box.setItemText(2, _translate("PurificationWindow", "3"))
        self.num_col_combo_box.setItemText(3, _translate("PurificationWindow", "4"))
        self.equilibrate_lbl.setText(_translate("PurificationWindow", "Equilibrate"))
        self.equilibrate_vol_lbl.setText(_translate("PurificationWindow", "Volume:"))
        self.equilibriate_flowpath_lbl.setText(_translate("PurificationWindow", "Flow Path:"))
        self.label.setText(_translate("PurificationWindow", "CV"))
        self.equil_flowpath.setItemText(0, _translate("PurificationWindow", "Pre Column Waste"))
        self.equil_flowpath.setItemText(1, _translate("PurificationWindow", "Post Column Waste"))
        self.load_lbl.setText(_translate("PurificationWindow", "Load"))
        self.load_ph_lbl.setText(_translate("PurificationWindow", "Volume:"))
        self.label_3.setText(_translate("PurificationWindow", "Flow Path:"))
        self.label_2.setText(_translate("PurificationWindow", "CV"))
        self.load_flowpath.setItemText(0, _translate("PurificationWindow", "Pre Column Waste"))
        self.load_flowpath.setItemText(1, _translate("PurificationWindow", "Post Column Waste"))
        self.load_flowpath.setItemText(2, _translate("PurificationWindow", "Flow Through Collector"))
        self.wash_lbl.setText(_translate("PurificationWindow", "Wash"))
        self.wash_ph_lbl.setText(_translate("PurificationWindow", "Volume:"))
        self.label_4.setText(_translate("PurificationWindow", "Flow Path:"))
        self.label_6.setText(_translate("PurificationWindow", "CV"))
        self.wash_flowpath.setItemText(0, _translate("PurificationWindow", "Pre Column Waste"))
        self.wash_flowpath.setItemText(1, _translate("PurificationWindow", "Post Column Waste"))
        self.wash_flowpath.setItemText(2, _translate("PurificationWindow", "Flow Through Collector"))
        self.elute_lbl.setText(_translate("PurificationWindow", "Elute"))
        self.elute_ph_lbl.setText(_translate("PurificationWindow", "Volume:"))
        self.label_5.setText(_translate("PurificationWindow", "Flow Path:"))
        self.label_7.setText(_translate("PurificationWindow", "CV"))
        self.elute_flowpath.setItemText(0, _translate("PurificationWindow", "Pre Column Waste"))
        self.elute_flowpath.setItemText(1, _translate("PurificationWindow", "Post Column Waste"))
        self.elute_flowpath.setItemText(2, _translate("PurificationWindow", "Flow Through Collector"))
        self.elute_flowpath.setItemText(3, _translate("PurificationWindow", "Fraction Collector"))
        self.label_8.setText(_translate("PurificationWindow", "Current Step:"))
        self.current_step_display_btn.setText(_translate("PurificationWindow", "--"))
        self.label_9.setText(_translate("PurificationWindow", "Status:"))
        self.status_display_btn.setText(_translate("PurificationWindow", "--"))
        self.estimated_time_remaining_lbl.setText(_translate("PurificationWindow", "Estimated Time: <..> min(s)"))
        self.start_btn.setText(_translate("PurificationWindow", "START"))
        self.pause_btn.setText(_translate("PurificationWindow", "PAUSE"))
        self.hold_btn.setText(_translate("PurificationWindow", "HOLD"))
        self.skip_btn.setText(_translate("PurificationWindow", "SKIP TO NEXT"))
        self.stop_btn.setText(_translate("PurificationWindow", "STOP"))
        self.close_btn.setText(_translate("PurificationWindow", "Close"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    PurificationWindow = QtWidgets.QMainWindow()
    ui = Ui_PurificationWindow()
    ui.setupUi(PurificationWindow)
    PurificationWindow.show()
    sys.exit(app.exec_())
