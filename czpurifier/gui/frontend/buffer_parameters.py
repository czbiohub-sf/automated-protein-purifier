...
class Ui_BuffersWindow(object):
    def setupUi(self, BuffersWindow):
        ...
        self.load_volume_needed = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.load_volume_needed.setFont(font)
        self.load_volume_needed.setText("")
        self.load_volume_needed.setObjectName("load_volume_needed")
        self.gridLayout_4.addWidget(self.load_volume_needed, 0, 1, 1, 1)
...
if __name__ == "__main__":
    ...
    BuffersWindow = QtWidgets.QMainWindow()
    ui = Ui_BuffersWindow()
    ui.setupUi(BuffersWindow)
    BuffersWindow.show()
    sys.exit(app.exec_())
