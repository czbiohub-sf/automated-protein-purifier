...
"QPushButton:disabled#stop_btn{background-color:#696969}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 694, 297))
...
"QPushButton:pressed#hold_btn{background-color:#A9A9A9}")
    ...
    def retranslateUi(self, CustomProtocol):
        ...
        self.volume_val_lbl.setText(_translate("CustomProtocol", "2"))
        self.step_num.setText(_translate("CustomProtocol", "1"))
        ...
        self.progressLabel.setText(_translate("CustomProtocol", "TextLabel"))
