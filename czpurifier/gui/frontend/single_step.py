...
# WARNING!! MANUAL CHANGE MADE IN LINE 20
...
class Ui_StepWidget(object):
    ...
    def retranslateUi(self, StepWidget):
        ...
        self.flowpath_combo_box.setItemText(2, _translate("StepWidget", "Flow Through Column"))
        self.flowpath_combo_box.setItemText(3, _translate("StepWidget", "Fraction Column"))
        ...
        self.port_combo_box.setItemText(1, _translate("StepWidget", "LOAD_BUFFER"))
        ...
        self.label_2.setText(_translate("StepWidget", "CV"))
